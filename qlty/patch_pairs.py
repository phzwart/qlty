"""
Extract pairs of patches from 2D and 3D image tensors with controlled displacement.

This module provides functionality to extract pairs of patches from 2D and 3D tensors
